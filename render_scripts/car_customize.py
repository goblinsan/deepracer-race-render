...
def modifyCarAttributes(texture_path, iterString, car_number, car_color, team_name, team_city):
    # update number
    car_num_path = "/generated/car_number-assets/car_number_"
    numberImage = load_image(texture_path + car_num_path + str(car_number).zfill(2) + ".png")
